...
export default class OrganizatinChart extends React.Component<IOrganizationChartProps,IOrganizatinChartState, {}> {
  public constructor(props: IOrganizationChartProps, state: IOrganizatinChartState){  
    super(props); 
    SPComponentLoader.loadCss(`${this.props.siteurl}/SiteAssets/Remo%20Portal%20Assets/css/OrgChartStyle.css`);
    SPComponentLoader.loadCss("https://remodigital.sharepoint.com/sites/Remo/SiteAssets/css/style.css");
SPComponentLoader.loadCss("https://remodigital.sharepoint.com/sites/Remo/SiteAssets/css/responsive.css");
    this.state = {               
        template: "ula"          
    };         
  }
            ...
            chart.editUI.on('field', function(sender, args){
                if (args.type == 'edit' && args.name == 'Manager'){
                    ...
                    if (txt){
                        ...
                        var managername:any;
                        $.ajax({
                            url: `https://remodigital.sharepoint.com/sites/Remo/_api/web/lists/getbytitle('OrgChart Master')/items?$select=ID,Title,Manager/Id,Manager/Title,Designation,Attachments,AttachmentFiles&$expand=Manager/Id,AttachmentFiles`,
                            type: "GET",
                            headers: {
                                "Accept": "application/json;odata=verbose",
                            },
