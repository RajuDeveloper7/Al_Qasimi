...
export default class PoliciesProcedures extends React.Component<IPoliciesProceduresProps,IPoliciesProcedureState, {}> {
  ...
  public GetDocumentCenterLinks(){  
    ...
    $.ajax({  
        url: `${this.props.siteurl}/_api/web/lists/getbytitle('PolicyandProcedureMaster')/items?$select=Title,HoverOnImage,AccessibleTo/Title,HoverOffImage,URL&$expand=AccessibleTo&$orderby=Order0 asc&$filter=IsActive eq 1 and AccessibleTo/Id eq ${UserID}`,  
        type: "GET",  
